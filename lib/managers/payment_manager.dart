...
//   final Function() onPaymentVerified;
...
//     final email = "customer@grocery.com";
...
//     } catch (e) {
//       onError("Razorpay Init Error: $e");
//     }
//   }

//   void _handlePaymentSuccess(PaymentSuccessResponse response) async {
//     if (_pendingBackendOrderId == null) {
//       onError("Order ID lost. Try again.");
//       return;
//     }

//     final verified = await ApiService.verifyPayment({
//       "order_id": _pendingBackendOrderId,
//       "razorpay_payment_id": response.paymentId,
//       "razorpay_order_id": response.orderId,
//       "razorpay_signature": response.signature,
//     });

//     verified ? onPaymentVerified() : onError("Payment verification failed");
//   }
...
//     onError("External Wallet: ${response.walletName}");
//   }
// }
