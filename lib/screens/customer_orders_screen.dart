...
// import 'order_detail_screen.dart'; // ✅ Import the Details Screen
...
//   Map<String, String> _shopMap = {}; // Maps ShopID -> ShopName

//   // UI State
//   bool _isLoading = true;
//   String _selectedFilter = "All";
//   final List<String> _filterOptions = ["All", "Pending", "Packed", "Delivered", "Cancelled"];
...
//         setState(() {
//           _allOrders = orders;
//           _filterOrders(); // Apply current filter
//           _isLoading = false;
//         });
//       }
//     } catch (e) {
...
//                                 side: status.toLowerCase() == 'cancelled' ? const BorderSide(color: Colors.red) : BorderSide.none
//                               ),
...
//                                       // Order UUID
//                                       Text("🧾 Order #: ${order['order_uuid'] ?? 'N/A'}", style: const TextStyle(fontSize: 12, color: Colors.grey)),
