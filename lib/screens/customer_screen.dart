...
class CustomerOrdersScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text("My Orders")));
}
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PlaceholderScreen("Profile"))),
            ),
            ListTile(
              leading: const Icon(Icons.settings_outlined),
              title: const Text('Settings'),
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PlaceholderScreen("Settings"))),
            ),
            const Divider(),
            ListTile(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildDashboardCard(
                    ...
                    color: Colors.orange,
                    onTap: () {
                      // ✅ 2. Navigate to the REAL ShopSelectionScreen
                  ...
                  _buildDashboardCard(
                    ...
                    label: "Wallet",
                    color: Colors.purple,
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PlaceholderScreen("Wallet"))),
                  ),
                  ...
                  _buildDashboardCard(
                    ...
                    label: "My Khata",
                    color: Colors.teal,
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PlaceholderScreen("My Khata"))),
                  ),
                ],
              ),
            ),
